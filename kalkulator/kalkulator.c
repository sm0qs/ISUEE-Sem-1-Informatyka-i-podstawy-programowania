...
double suma(const double *x, const double *y) { return (*x + *y); }

double roznica(const double *x, const double *y) { return (*x - *y); }

double iloczyn(const double *x, const double *y) { return (*x * *y); }
